...
<center className="mt-2">
	![Usage of the slash command '/config set option:Role Mention Cooldown Roles'](/static/docs/setting-role-mention-cooldown-roles.webp)
</center>
...
<center className="mt-2">
	![Usage of the slash command '/config set option:Role Mention Cooldown Time'](/static/docs/setting-role-mention-cooldown-time.webp)
</center>

A modal-box will then appear, in which you can then enter the time interval you want to assign.

<center className="mt-2">
	![Example of the Modal pop-up for setting the Role Mention Cooldown Time](/static/docs/modal-set-role-mention-cooldown-time.webp)
</center>
