...
With our new [/config troubleshoot](/bot/config-commands/config/troubleshoot) command you can quickly check the most common issues with your setup!
</Callout>
...
Visit [https://lurkr.gg/support](https://lurkr.gg/support) for support.