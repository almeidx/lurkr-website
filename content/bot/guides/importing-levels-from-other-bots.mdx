...
description: Keep the Leveling Momentum! Learn how to easily bring over member levels and progress from other bots, ensuring a smooth transition to Lurkr
---
...
![Import XP bot selection](/_assets/V7zolEQ.png)
...
![Import role rewards selection](/_assets/QVYwDPA.png)

---

### Minimum Level Option

Lastly, you will be prompted with a 'min_level' option. This **optional** field lets you control down to which level you want to import your users.
...
![Minimum level option](/_assets/Discord_kMmfBtHwRR.png)
...
![Import success message](/_assets/px2NXLp.png)
...
All of which is why we allow you to export/download your leveling data at **any time**, **instantly** and completely for free! Check out how in the guide for [exporting leveling leaderboard](/bot/guides/exporting-leveling-leaderboard)!
...
<Callout type="error">
If you experienced any issues in this process, please feel free to seek support in our support server at [https://discord.com/invite/XUQAnkq2vy](https://discord.com/invite/XUQAnkq2vy)!
</Callout>
...
Learn more about [setting up server leveling](/bot/guides/setting-up-server-leveling).