...
<center>
	![Usage of the slash command '/config toggle option:Leveling System'](@/assets/docs/toggling-leveling-system.webp)
</center>
...
<center>
	![Usage of the slash command '/config set option:Leveling Channels'](@/assets/docs/setting-leveling-channels.webp)
</center>
...
<center>
	![If you don't do anything, the channels will be set as they are!](@/assets/docs/leveling-switch-to-whitelist.webp)
</center>
