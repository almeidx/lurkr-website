...
The milestone interval can be any number within reason as long as it is a _**multiple of 10**_. Conceivably, the
interval can be set to 10, or it can be set to **100,000**.
...
and even role mentions as long as it is within the 2000-character limit of all messages.
