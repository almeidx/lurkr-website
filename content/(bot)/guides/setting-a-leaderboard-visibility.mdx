...
if you have a [Vanity URL](/bot/guides/setting-a-leaderboard-vanity-url) set or not.
...
In order to set your leaderboards' visibility, go to your [servers dashboard](https://lurkr.gg/guilds) and select the
**Leveling** category.
