...
<center>
	![Usage of the slash command '/config set option:Role Mention Cooldown Roles'](@/assets/docs/setting-role-mention-cooldown-roles.webp)
</center>
...
<center>
	![Usage of the slash command '/config set option:Role Mention Cooldown Time'](@/assets/docs/setting-role-mention-cooldown-time.webp)
</center>

A modal-box will then appear, in which you can then enter the time interval you want to assign.

<center>
	![Example of the Modal pop-up for setting the Role Mention Cooldown Time](@/assets/docs/modal-set-role-mention-cooldown-time.webp)
</center>
