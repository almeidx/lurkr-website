...
<center>
	![The `/config set option:Level Up Message` command](../../_assets/config-set-level-up-message.png)
</center>
...
<center>
	![The modal dialog box for setting the Level Up Message](../../_assets/set-level-up-message-modal.png)
</center>
...
<center>
	![The `/config set option:Level Up Message Destination` command](../../_assets/config-set-level-up-message-destination.png)
</center>
...
<center>
	![The select menu for setting the Level Up Message Destination](../../_assets/set-level-up-message-destination-select-menu.png)
</center>
...
<center>
	![The `/config set option:Minimum Level Announcement Threshold` command](../../_assets/config-set-minimum-leveling-announcement-threshold.png)
</center>
...
<center>
	![The `/config set option:Factor For Leveling Announcements` command](../../_assets/config-set-factor-for-leveling-announcements.png)
</center>
...
<center>
	![The `/config set option:Only Announce Level Ups Together With Role Rewards` command](../../_assets/config-toggle-only-announce-level-ups-together-with-role-rewards.png)
</center>
