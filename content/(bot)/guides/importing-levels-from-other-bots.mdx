...
If you want to see this list get expanded, let us know which bot you would like to switch over from in our support server in the #suggestions channel!
We'll let you know if it's technically possible and if enough people are interested, add it to our feature request list!

<Card href={SUPPORT_SERVER_INVITE}>
    💬 Support Server
</Card>
...
<center>
    ![](../../_assets/Discord_kMmfBtHwRR.png)
</center>
...
<Card href="/docs/guides/exporting-leveling-leaderboard">
