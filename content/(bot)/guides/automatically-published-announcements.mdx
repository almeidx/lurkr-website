...
<center>
	![Creating an announcement channel in Discord](../../_assets/kzgyljb.png)
</center>
...
You can enter as many channels as your current server plan will allow. You can check the limits on the Premium Perks page!

<center>
	![Usage of the slash command to configure auto publisher](https://i.imgur.com/98qCXCi.png)
</center>
