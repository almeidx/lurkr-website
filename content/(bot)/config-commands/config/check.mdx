...
This method of the [config ](./)command can be used to check if you have inputted all of your configuration options
correctly. The command will reply with an embed containing the option name and the value it is set to.
