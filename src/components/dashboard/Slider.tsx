	...
	return (
		<div className="mb-3 flex max-w-lg items-center gap-4 px-2.5">
			<div className="flex-1">
				<input
					className="h-1.5 w-full cursor-pointer appearance-none rounded-2xl outline-none slider-thumb:h-4 slider-thumb:w-4 slider-thumb:appearance-none slider-thumb:rounded-full slider-thumb:border-none slider-thumb:bg-primary"
					ref={ref}
					type="range"
					min={min}
					max={max}
