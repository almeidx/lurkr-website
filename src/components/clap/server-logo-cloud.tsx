...
function FeaturedGuilds({
	...
	return (
		<div className="relative">
			<div className="absolute top-0 right-11/12 left-0 z-10 h-full bg-gradient-to-r from-white to-transparent dark:from-gray-950" />

			<Marquee className="absolute inset-0" play speed={speed} direction={direction}>
				{guilds.map((guild) => (
			...
			<div className="absolute top-0 right-0 left-11/12 z-10 h-full bg-gradient-to-l from-white to-transparent dark:from-gray-950" />
		</div>
	);
}
