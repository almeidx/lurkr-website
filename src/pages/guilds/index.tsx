...
export default function Guilds(props: InferGetServerSidePropsType<typeof getServerSideProps>) {
	...
	return (
		<div className="min-h-screen-no-footer bg-discord-dark flex flex-col items-center justify-center gap-y-8 py-6 text-center sm:pt-0">
			<Head>
				<title>Dashboard | Lurkr</title>
			</Head>

			<h1 className="text-2xl font-bold text-white sm:text-4xl">Pick the server you would like to configure</h1>
