...
import togglingLevelingSystem from '@/assets/docs/toggling-leveling-system.webp'
import settingLevelingChannels from '@/assets/docs/setting-leveling-channels.webp'
import levelingSwitchToWhitelist from '@/assets/docs/leveling-switch-to-whitelist.webp'
