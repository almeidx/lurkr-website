...
import settingRoleMentionCooldownRolesImg from '@/assets/docs/setting-role-mention-cooldown-roles.webp'
import settingRoleMentionCooldownTimeImg from '@/assets/docs/setting-role-mention-cooldown-time.webp'
import modalSetRoleMentionCooldownTimeImg from '@/assets/docs/modal-set-role-mention-cooldown-time.webp'
