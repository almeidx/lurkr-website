		...
		<>
			<div className="mt-12 flex items-center gap-4">
				...
				>
					<span className="sr-only">
						{targetGuildHref?.startsWith("https:") ? "Add Lurkr to the searched server" : "Go to the searched server"}
					</span>
			...
			<div className="my-7 flex max-w-2xl flex-wrap justify-center gap-12">
				{filteredGuilds.map((guild, idx) => (
					...
					>
						<div
							className="invisible absolute -left-11 -top-14 z-50 w-40 rounded-lg bg-darker px-3 py-2 text-white shadow-md outline outline-1 outline-white group-hover:visible"
							role="tooltip"
						>
