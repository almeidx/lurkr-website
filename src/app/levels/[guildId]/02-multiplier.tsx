...
import { RoleDisplay } from "./01-role-reward.tsx";

export function MultiplierDisplay({ id, multiplier, targets, type }: Multiplier) {
	return (
		<div className="flex items-center gap-4">
			<span className="flex h-9 w-9 items-center justify-center rounded-lg border border-white bg-[#1e1f22] text-xl text-[#fff]">
				{multiplier}
			</span>
