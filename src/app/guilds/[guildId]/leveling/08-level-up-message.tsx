...
import { DEFAULT_XP_MESSAGE } from "@/lib/guild-config.ts";
	...
	return (
		<div className="flex max-w-3xl flex-col gap-2">
			<div className="flex items-center justify-between">
				<label className="flex items-end gap-2 text-lg tracking-tight text-white/75 md:text-xl" htmlFor="xpMessage">
					Set the level up message to say something custom…
					<p className="mb-1 text-xs font-light text-white/50">(Max. 1,800 chars)</p>
				</label>
