  ...
  return (
    <div className={styles.container}>
      <nav>
        ...
        >
          <FaDiscord
            style={{ fill: "#5c6bc0", height: "90px", width: "90px" }}
          />
        </div>
      </nav>
      ...
      <ul className={styles["item-list"]}>
        ...
        <li
          ...
          onClick={() => window.open("https://pepe-is.life/bot-invite")}
        >
        ...
        <li
          className={styles["list-item"]}
          onClick={() => window.open("https://docs.pepe-is.life/docs")}
        >
