  ...
  return (
    <div className="bg-discord-dark w-full flex flex-col items-center">
      ...
      <header className="flex flex-col items-center justify-center">
        <h1 className="text-white font-bold text-4xl">Privacy Policy</h1>
      ...
      <main className="max-w-4xl">
        ...
        <Link href="#information-collection-and-use">
          <a className="text-gray-200 font-bold text-3xl uppercase">Information Collection and Use</a>
        </Link>
        ...
        <Link href="#log-data">
          <a className="text-gray-200 font-bold text-3xl uppercase">Log Data</a>
        </Link>
        ...
        <Link href="#cookies">
          <a className="text-gray-200 font-bold text-3xl uppercase">Cookies</a>
        </Link>
        ...
        <Link href="#security">
          <a className="text-gray-200 font-bold text-3xl uppercase">Security</a>
        </Link>
        ...
        <Link href="#links-to-other-sites">
          <a className="text-gray-200 font-bold text-3xl uppercase">Links to Other Sites</a>
        </Link>
        ...
        <Link href="#changes">
          <a className="text-gray-200 font-bold text-3xl uppercase">Changes to This Privacy Policy</a>
        </Link>
        ...
        <Link href="#contact">
          <a className="text-gray-200 font-bold text-3xl uppercase">Contact Us</a>
        </Link>
