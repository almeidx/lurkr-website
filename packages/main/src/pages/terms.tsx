  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        <a target="_blank" rel="nofollow noreferrer" href="https://pepemanager.com">
          pepemanager.com
        </a>{' '}
        ...
        &quot;your&quot;) and this Website operator (&quot;Operator&quot;, &quot;we&quot;, &quot;us&quot; or
        &quot;our&quot;). By accessing and using the Website and Services, you acknowledge that you have read,
        ...
        this Agreement, in which case the terms &quot;User&quot;, &quot;you&quot; or &quot;your&quot; shall refer to
        such entity. If you do not have such authority, or if you do not agree with the terms of this Agreement, you
        must not accept this Agreement and may not access and use the Website and Services. You acknowledge that this
        Agreement is a contract between you and the Operator, even though it is electronic and is not physically signed
        by you, and it governs your use of the Website and Services.
      </p>

      <a href="#age-requirement" className={styles.mediumAnchor}>
        Age requirement
      </a>
      ...
      <a href="#links-to-other-resources" className={styles.mediumAnchor}>
      ...
      <p>
        ...
        access through a link on the Website and Services. Your linking to any other off-site resources is at your own
        risk.
      </p>

      <a href="#prohibited-uses" className={styles.mediumAnchor}>
        Prohibited uses
      </a>
      ...
      <a href="#intellectual-property-rights" className={styles.mediumAnchor}>
      ...
      <p>
        ...
        and be granted, rights to claim priority from, such rights and all similar or equivalent rights or forms of
        protection and any other results of intellectual activity which subsist or will subsist now or in the future in
        any part of the world. This Agreement does not transfer to you any intellectual property owned by the Operator
        or third parties, and all rights, titles, and interests in and to such property will remain (as between the
        parties) solely with the Operator. All trademarks, service marks, graphics and logos used in connection with the
        Website and Services, are trademarks or registered trademarks of the Operator or its licensors. Other
        trademarks, service marks, graphics and logos used in connection with the Website and Services may be the
        trademarks of other third parties. Your use of the Website and Services grants you no right or license to
        reproduce or otherwise use any of the Operator or third party trademarks.
      </p>

      <a href="#severability" className={styles.mediumAnchor}>
        Severability
      </a>
      ...
      <a href="#changes-and-amendments" className={styles.mediumAnchor}>
      ...
      <p>
        ...
        updated date at the bottom of this page. Continued use of the Website and Services after any such changes shall
        constitute your consent to such changes.
      </p>

      <a href="#acceptance-of-these-terms" className={styles.mediumAnchor}>
      ...
      <a href="#contacting-us" className={styles.mediumAnchor}>
        Contacting us
      </a>

      <p>
        If you would like to contact us to understand more about this Agreement or wish to contact us concerning any
        matter relating to it, you may send an email to ad&#109;i&#110;&#64;&#97;lm&#101;i&#100;&#120;.de&#118;.
      </p>
    </div>
  );
}
