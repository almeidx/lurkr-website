...
export default function PrivacyPolicy() {
  return (
    <div className={styles.container}>
      ...
      <a className={styles.largeAnchor} href="#interpretation-and-definitions">
        Interpretation and Definitions
      </a>

      <a href="#interpretation" className={styles.mediumAnchor}>
        Interpretation
      </a>
      ...
      <a href="#definitions" className={styles.mediumAnchor}>
        Definitions
      </a>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Pepe Manager.
          </p>
        </li>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Hessen, Germany
          </p>
        </li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Pepe Manager, accessible from{' '}
            <a href="https://pepemanager.com" rel="external nofollow noopener noreferrer" target="_blank">
              https://pepemanager.com
            </a>
          </p>
        </li>
      ...
      <a href="#collecting-and-using-your-personal-data" className={styles.largeAnchor}>
        Collecting and Using Your Personal Data
      </a>

      <a href="#types-of-data-collected" className={styles.mediumAnchor}>
        Types of Data Collected
      </a>

      <a href="#personal-data" className={styles.smallAnchor}>
        Personal Data
      </a>
      ...
      <a href="#usage-data" className={styles.smallAnchor}>
        Usage Data
      </a>
      ...
      <a href="#tracking-technologies-and-cookies" className={styles.smallAnchor}>
      ...
      <ul>
        ...
        <li>
          <strong>Web Beacons.</strong> Certain sections of our Service may contain small electronic files known as web
          beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for
          example, to count users who have visited those pages and for other related website statistics (for example,
      ...
      <a href="#use-of-your-personal-data" className={styles.mediumAnchor}>
      ...
      <a href="#retention-of-your-personal-data" className={styles.mediumAnchor}>
      ...
      <a href="#transfer-of-your-personal-data" className={styles.mediumAnchor}>
      ...
      <a href="#disclosure-of-your-personal-data" className={styles.mediumAnchor}>
        Disclosure of Your Personal Data
      </a>

      <a href="#business-transactions" className={styles.smallAnchor}>
      ...
      <a href="#law-enforcement" className={styles.smallAnchor}>
        Law enforcement
      </a>
      ...
      <a href="#other-legal-requirements" className={styles.smallAnchor}>
      ...
      <a href="#security-of-your-personal-data" className={styles.smallAnchor}>
      ...
      <a href="#children-privacy" className={styles.largeAnchor}>
        Children{"'"}s Privacy
      </a>
      ...
      <a href="#links-to-other-websites" className={styles.largeAnchor}>
      ...
      <a href="#changes-to-this-privacy-policy" className={styles.largeAnchor}>
      ...
      <a href="#contact-us" className={styles.largeAnchor}>
        Contact Us
      </a>
      ...
      <ul>
        <li>
          By email:{' '}
          <a className={styles.mailAnchor} href="mailto:admin@almeidx.dev">
            admin@almeidx.dev
          </a>
        </li>
      </ul>
