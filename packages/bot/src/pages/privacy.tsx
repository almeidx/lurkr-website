  ...
  return (
    <div className="bg-discord-dark w-full flex flex-col items-center">
      ...
      <main className="max-w-4xl">
        ...
        <Link href="#log-data">
          <a className="text-gray-200 font-bold text-xl sm:text-3xl uppercase mx-3 sm:mx-0" id="log-data">
            Log Data
          </a>
        </Link>
        ...
        <Link href="#cookies">
          <a className="text-gray-200 font-bold text-xl sm:text-3xl uppercase mx-3 sm:mx-0" id="cookies">
            Cookies
          </a>
        </Link>
        ...
        <Link href="#security">
          <a className="text-gray-200 font-bold text-xl sm:text-3xl uppercase mx-3 sm:mx-0" id="security">
            Security
          </a>
        </Link>
        ...
        <Link href="#links-to-other-sites">
          <a className="text-gray-200 font-bold text-xl sm:text-3xl uppercase mx-3 sm:mx-0" id="links-to-other-sites">
        ...
        <Link href="#children-privacy">
          <a className="text-gray-200 font-bold text-xl sm:text-3xl uppercase mx-3 sm:mx-0" id="children-privacy">
            Children&apos;s Privacy
          </a>
        </Link>
