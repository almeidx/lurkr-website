...
const showcases: ShowcaseProps[] = [
  {
    ...
    path: '/static/showcases/levelling.mp4',
  ...
  },
  {
    ...
    path: '/static/showcases/emoji-list.mp4',
  ...
  },
  {
    ...
    path: '/static/showcases/mee6-import.mp4',
  ...
  },
  {
    ...
    path: '/static/showcases/emojis.mp4',
  ...
  },
  {
    ...
    path: '/static/showcases/images.mp4',
...
export default function Bot() {
  return (
    <div className={styles.container}>
      ...
      <header>
        <Image src="/static/avatar.png" width={64} height={64} alt="Pepe Manager bot avatar image" />
