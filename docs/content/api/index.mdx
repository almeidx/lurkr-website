...
1. Create your API key in your <ExternalLink href={`${BASE_URL}/profile`}>profile page</ExternalLink>. Make sure to
   allow access to some servers
...
To create and manage your API keys, visit your <ExternalLink href={`${BASE_URL}/profile`}>profile page</ExternalLink>.

## Rate Limiting

The API enforces rate limits to ensure fair usage and system stability. You can make 1500 requests per minute per API
key.
