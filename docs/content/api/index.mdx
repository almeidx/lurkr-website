...
The Lurkr API is a RESTful API that enables seamless integration with Lurkr's features from your own applications. This
documentation will help you get started with making requests and handling responses.
...
The API enforces rate limits to ensure fair usage and system stability. You can make 1500 requests per minute per
identity (API key, authenticated user, or IP address).
...
how long to wait before making new requests. If you continue hitting rate limits, you will be temporarily banned.
...
{/* prettier-ignore */}
If you need help or have questions about the API, join our <ExternalLink className="text-primary" href={SUPPORT_SERVER_INVITE} target="_blank" rel="noopener noreferrer">Discord
support server</ExternalLink>.
