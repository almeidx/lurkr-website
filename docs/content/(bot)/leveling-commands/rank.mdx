...
You also have the option to send a `text_mode` rank card which sends the information without the image rank card. This
can be useful if the image isn't being displayed properly on your device or if you are trying to save data bandwidth.
