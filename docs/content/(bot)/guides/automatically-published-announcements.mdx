...
therefore you need to grant either Lurkr (The Bot Account) or Lurkr (The Integration Role) the **Send Messages** and
**Manage Messages** permissions in the newly created announcement channel.
