...
<Callout type="warn" title="Please read this section before moving forward to prevent data-loss and unnecessary waiting during the transition!">
    While Lurkr lets you painlessly import all of your leveling data, this feature requires significant processing power. Not only that but we are obligated to retrieve data from other bots within their rate-limits (i.e., how fast we can access their website). Because of this, the `/importxp` command can only be used **once every hour**!
...
| --------------------------------------- | -------------------------- | -------------------------- |
| [MEE6](https://mee6.xyz)                | ✅                         | ✅                         |
| [Amari](https://amaribot.com/)          | ⚠️ Currently Unavailable\* | ⚠️ Currently Unavailable\* |
| [Polaris](https://gdcolon.com/polaris/) | ⚠️ Manual Only\*\*         | ⚠️ Manual Only\*\*         |
| [Arcane](https://arcane.bot/)           | ❌ (Not Supported)         | ❌ (Not Supported)         |

\* Amari's API has been taken down, so importing from Amari is currently not available.

\*\* Polaris's API has been retired. If you have your Polaris data as a JSON file, you can request a manual import in
our support server.
...
<Card href="/guides/exporting-leveling-leaderboard">📃 Exporting Leveling Leaderboard</Card>
