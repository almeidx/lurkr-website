...
By default, the Leaderboard of your server is globally visible, which means it can be searched by robots (indexed) and
be put onto Google and other search engines. Sometimes you might not want your server to be publically visible though,
if it's just a server for you and your friends, or it's a secret society!
...
In order to set your leaderboards' visibility, go to your <ExternalLink href={`${BASE_URL}/guilds`}>servers
dashboard</ExternalLink> and select the **Leveling** category.
