...
Simply use a variable at the start and end of the message you'd like to conditionally show, and add a `#` and `/` to the start and end of the conditional variables respectfully.
