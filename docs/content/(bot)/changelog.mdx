...
import { BASE_URL, SUPPORT_SERVER_INVITE, UPDATES_CHANNEL_LINK } from "@/shared-links.ts";
...
- Added a **public API** for other developers to take advantage of Lurkr's deep Leveling System for their own projects!
  ...
  - You can create and customize your API key on your profile page: <ExternalLink
    href={`${BASE_URL}/profile`}>lurkr.gg/profile</ExternalLink>
...
- Added an API key generation section to the profile page! <ExternalLink
  href={`${BASE_URL}/profile`}>lurkr.gg/profile</ExternalLink>
...
- Added a profile page! <ExternalLink href={`${BASE_URL}/profile`}>lurkr.gg/profile</ExternalLink>
