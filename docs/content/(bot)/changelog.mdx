...
- Added visibility options for the web leaderboard!
  - Allows you to change if your leaderboard can be accessed by anyone, by server members or only by managers/administrators.
...
- Fixed Lurkr informing users about 20% Leveling Boost when using `/vote` despite the multiplier being disabled on the server.
...
- Added individually stackable role rewards!
  - This now lets you pick and choose which specific role reward should stick around on the User, and which ones should be removed when another role reward gets unlocked!

- Disabled commands that are linked to Multipliers or Role Rewards; they now redirect you to use our Dashboard! (It's better)
...
- Added a profile page! [lurkr.gg/profile](/profile)
