...
This method of the [config](./) command can be used to reset [toggle](./toggle) options back to their default state.

The reset method **will not** work on set options, please refer to the [delete](./delete) method!
